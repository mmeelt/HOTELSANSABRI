...
Atelier::Atelier(const string& date, const string& lieu, const string& description, unique_ptr<TravailleurSocialEvenementiel> resp,
                 const string& sujet, const string& duree, int capacite)
    : Evenement(date, lieu, description, move(resp)), sujet(sujet), duree(duree), capacite(capacite) {}

// Constructeur de recopie
Atelier::Atelier(const Atelier& other)
    : Evenement(other.getDate(), other.getLieu(), other.getDescription(), 
      other.getResponsable().get() != nullptr ? make_unique<TravailleurSocialEvenementiel>(*other.getResponsable()) : nullptr),
      sujet(other.sujet), duree(other.duree), capacite(other.capacite) {}
