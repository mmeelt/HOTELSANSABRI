...
void TravailleurSocial::ajouterEvenement(std::unique_ptr<Evenement> evenement) {
...
istream& operator>>(istream& is, TravailleurSocial& t) {
    is >> static_cast<TravailleurSocial&>(t);  // Read Utilisateur fields first
    return is;
}
